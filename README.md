...
![BDX AMP banner](images/banner.png)
...
We provide an example UI extension that will load upon enabling your extension defined in `source/bdx/bdx/ui_extension_example.py`.
